...
var _IHashProvider = _interopRequireDefault(require("@modules/users/providers/HashProvider/models/IHashProvider"));
...
let UpdateProfileService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (!user) {
      throw new _AppError.default('User not found', 401);
    }
    ...
    if (password && !old_password) {
      throw new _AppError.default('You need inform the old password to set a new password');
    }
